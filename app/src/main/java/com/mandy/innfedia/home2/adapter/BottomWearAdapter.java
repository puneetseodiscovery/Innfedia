...
public class BottomWearAdapter extends RecyclerView.Adapter<BottomWearAdapter.ViewHolder> {
    ...
    Context context;
    List<GetSubCategoryApi.BottomWear> arrayList;
    FragmentManager manager;

    public BottomWearAdapter(Context context, List<GetSubCategoryApi.BottomWear> arrayList, FragmentManager manager) {
