package com.mandy.innfedia.ForgotPassword;
...
// go the login activity
    ...
    private void getOtp() {
        if (TextUtils.isEmpty(edtPhone.getText().toString())) {
            ...
            Call<GetMeesageApi> call = apiInterface.getOtp(edtPhone.getText().toString());
    ...
    private void confirmOtp() {
        ...
        if (TextUtils.isEmpty(edtOtp.getText().toString())) {
            ...
            ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
            Call<GetMeesageApi> call = apiInterface.sendOtp(edtOtp.getText().toString(), edtPhone.getText().toString());
            final Dialog dialog = ProgressBarClass.showProgressDialog(ForgotPasswordActivity.this);
            dialog.show();
    ...
    private void setPassword() {
        ...
        if (TextUtils.isEmpty(edtPassword.getText().toString())) {
            ...
            ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
            Call<GetMeesageApi> call = apiInterface.resetPassword(edtPassword.getText().toString(), edtPhone.getText().toString());
            final Dialog dialog = ProgressBarClass.showProgressDialog(ForgotPasswordActivity.this);
            dialog.show();
