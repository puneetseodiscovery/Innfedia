...
public class ExploreMoreAdapter extends RecyclerView.Adapter<ExploreMoreAdapter.ViewHolder> {
    ...
    Context context;
    List<GetSubCategory.ExploreMore> arrayList;

    FragmentManager manager;

    public ExploreMoreAdapter(Context context, List<GetSubCategory.ExploreMore> arrayList, FragmentManager manager) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        GetSubCategory.ExploreMore datu = arrayList.get(i);
