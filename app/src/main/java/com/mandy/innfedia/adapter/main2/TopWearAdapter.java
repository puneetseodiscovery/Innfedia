...
public class TopWearAdapter extends RecyclerView.Adapter<TopWearAdapter.ViewHolder> {
    ...
    Context context;
    List<GetSubCategory.TopWear> arrayList;
    FragmentManager manager;

    public TopWearAdapter(Context context, List<GetSubCategory.TopWear> arrayList, FragmentManager manager) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        GetSubCategory.TopWear datum = arrayList.get(i);
