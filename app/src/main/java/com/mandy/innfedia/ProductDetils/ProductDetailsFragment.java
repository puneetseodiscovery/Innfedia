...
import com.mandy.innfedia.ProductDetils.adapter.ColorAdapter;
import com.mandy.innfedia.ProductDetils.adapter.SizeAdapter;
import com.mandy.innfedia.adapter.ViewPagerProductImageAdapter;
import com.mandy.innfedia.ProductDetils.adapter.SeeRelatedItemAdapter;
import com.mandy.innfedia.fragment.CommentFragment;
...
public class ProductDetailsFragment extends Fragment {
    ...
    private void init() {
        ...
        btnBuy = (Button) view.findViewById(R.id.btnBuynow);
    ...
    private void getData() {
        ...
        Call<GetProductDetailsApi> call = apiInterface.getProductDetails("Bearer " + sharedToken.getShared(), id);
    ...
    private void getRelatedItem() {
        ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
        Call<GetProductList> call = apiInterface.getRelatedList("Bearer " + sharedToken.getShared(), cid);
